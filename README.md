...
Compiled from: harness-playbook · onboarding-new-project · greenfield-harness (+ review patch v1.1).
...
docs/        full step-by-step guides the kit was distilled from (Ukrainian)
...
| Gates | commit #1 | user-level day 0; in repo — week 4+ | week 3 |
...
## Docs
Full guides (Ukrainian, ~1000 lines each) the kit is distilled from:
- docs/harness-playbook.uk.md — the 4-week program, step by step with examples
- docs/onboarding-new-project.uk.md — joining someone else's project
- docs/greenfield-harness.uk.md — starting a project from scratch, harness-first
