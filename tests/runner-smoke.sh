...
mkdir -p harness/evals/traces harness/evals/results harness/docker
cp -r "$KIT_DIR"/harness/docker/* harness/docker/ && cp "$KIT_DIR/harness/evals/run.sh" harness/evals/
cat > harness/evals/traces/001-smoke.md << 'T'
# 001: smoke
## Prompt
...
EVAL_LIMIT=1 ./harness/evals/run.sh
